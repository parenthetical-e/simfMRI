...
def run(n_iter,n_cond,n_trials):
	...
	One of the four free HRF parameters is randomly but identically
	perturbed in all BOLD models.
	"""
	...
	for ii in range(n_iter):
		...
		params = simfMRI.hrf.preturb_params(
		...
		acc_dm1,acc_dm2 = dm(trialset,acc,params)
	...
	f_name = ('delta_rand_learn_param_hrf_' + exp_conds + '_' 
			+ time_code + '.pkl')
